...
const elements = document.querySelectorAll('[data-gap-x], [data-gap-y]');

// Loop through each element
elements.forEach(element => {
  // Get the value of the "data-gap-x" and "data-gap-y" attributes
  const gapXValue = element.getAttribute('data-gap-x');
  const gapYValue = element.getAttribute('data-gap-y');
